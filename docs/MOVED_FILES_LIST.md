...
このファイルは、ドキュメント整理のために移動されたファイルの一覧です。

## 📊 移動統計

- **トラブルシューティングドキュメント**: 101ファイル → `docs/troubleshooting/`
- **スクリプトファイル**: 24ファイル → `docs/scripts/`
- **整理計画ドキュメント**: 3ファイル → `docs/`

## 📁 移動先ディレクトリ

### docs/troubleshooting/

一時的なトラブルシューティングガイドをアーカイブしています。

#### BigQueryスキーマ関連（30ファイル）
...
- MOVE_PLAN.md
- CLEANUP_SUMMARY.md
- MOVED_FILES_LIST.md（このファイル）

## 📝 注意事項

- 移動されたファイルはアーカイブとして保存されています
- 必要に応じて参照できますが、最新の情報はルートディレクトリのドキュメントを参照してください
- 移動日: 2026年1月13日
