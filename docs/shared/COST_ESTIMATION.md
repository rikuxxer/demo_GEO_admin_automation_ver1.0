...
### 2. Google Maps Geocoding API ⚠️ **最大コスト要因**
...
- **POI取得**: 月間20,000回 × 平均50MBスキャン = 1,000GB/月（約1TB/月）⚠️
...
| サービス | 月額コスト |
|---------|-----------|
| **Google Maps Geocoding API** | **約165,000円** ⚠️ |
...
### 1. Google Maps Geocoding API ⚠️ **最重要**
