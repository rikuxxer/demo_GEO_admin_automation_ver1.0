-- =============================================================================
-- UNIVERSEGEO BigQuery 全テーブル作成スクリプト（検証用・US データセット）
-- =============================================================================
-- プロジェクト: universe-geo-admin-dev-12246
-- データセット: universegeo_dataset_US（ロケーション US・検証用）
--
-- 前提: データセットは以下のコマンドで作成済みのこと。
--   bq mk --dataset --location=US universe-geo-admin-dev-12246:universegeo_dataset_US
--
-- 実行: BigQuery コンソールでジョブロケーションを US に合わせてから本SQLを実行。
-- =============================================================================

-- -----------------------------------------------------------------------------
-- 1. projects（案件）
-- -----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `universe-geo-admin-dev-12246.universegeo_dataset_US.projects` (
...
-- 2. segments（セグメント）
-- -----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `universe-geo-admin-dev-12246.universegeo_dataset_US.segments` (
...
-- 3. pois（地点情報）
-- -----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `universe-geo-admin-dev-12246.universegeo_dataset_US.pois` (
...
-- 4. users（ユーザー）
-- -----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `universe-geo-admin-dev-12246.universegeo_dataset_US.users` (
...
-- -----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `universe-geo-admin-dev-12246.universegeo_dataset_US.user_requests` (
  user_id STRING NOT NULL,
  name STRING,
  email STRING,
...
-- 6. messages（メッセージ）
-- -----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `universe-geo-admin-dev-12246.universegeo_dataset_US.messages` (
...
-- -----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `universe-geo-admin-dev-12246.universegeo_dataset_US.change_history` (
...
-- -----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `universe-geo-admin-dev-12246.universegeo_dataset_US.edit_requests` (
...
-- -----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `universe-geo-admin-dev-12246.universegeo_dataset_US.feature_requests` (
  request_id STRING NOT NULL,
  requested_by STRING NOT NULL,
...
-- -----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `universe-geo-admin-dev-12246.universegeo_dataset_US.visit_measurement_groups` (
  project_id STRING NOT NULL,
...
-- -----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `universe-geo-admin-dev-12246.universegeo_dataset_US.sheet_exports` (
...
-- -----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `universe-geo-admin-dev-12246.universegeo_dataset_US.sheet_export_data` (
...
-- -----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `universe-geo-admin-dev-12246.universegeo_dataset_US.report_requests` (
  request_id STRING NOT NULL,
  requested_by STRING NOT NULL,
  requested_by_name STRING NOT NULL,
  requested_at TIMESTAMP NOT NULL,
...
-- =============================================================================
-- ALTER TABLE `universe-geo-admin-dev-12246.universegeo_dataset_US.pois`
-- SET OPTIONS(partition_expiration_days=1095);
--
-- ALTER TABLE `universe-geo-admin-dev-12246.universegeo_dataset_US.segments`
-- SET OPTIONS(partition_expiration_days=1095);
--
-- ALTER TABLE `universe-geo-admin-dev-12246.universegeo_dataset_US.projects`
