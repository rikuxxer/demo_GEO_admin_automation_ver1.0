...
bq rm -f -t "${PROJECT_ID}:${DATASET_ID}.projects" 2>/dev/null
...
bq rm -f -t "${PROJECT_ID}:${DATASET_ID}.segments" 2>/dev/null
...
bq rm -f -t "${PROJECT_ID}:${DATASET_ID}.pois" 2>/dev/null
...
bq rm -f -t "${PROJECT_ID}:${DATASET_ID}.users" 2>/dev/null
...
bq rm -f -t "${PROJECT_ID}:${DATASET_ID}.user_requests" 2>/dev/null
...
bq rm -f -t "${PROJECT_ID}:${DATASET_ID}.messages" 2>/dev/null
...
bq rm -f -t "${PROJECT_ID}:${DATASET_ID}.change_history" 2>/dev/null
...
bq rm -f -t "${PROJECT_ID}:${DATASET_ID}.edit_requests" 2>/dev/null
...
bq rm -f -t "${PROJECT_ID}:${DATASET_ID}.feature_requests" 2>/dev/null
...
bq rm -f -t "${PROJECT_ID}:${DATASET_ID}.visit_measurement_groups" 2>/dev/null
